...
export type UpdateProfilePictureMutation = {
  __typename?: "Mutation"
  updateProfilePicture?: string | null
}

export type ItemsForSaleQueryVariables = Exact<{ [key: string]: never }>

export type ItemsForSaleQuery = {
  __typename?: "Query"
  itemsForSale?: Array<{
    __typename?: "Item"
    id: number
...
export type UserSalesQuery = {
  __typename?: "Query"
  userSales?: Array<{
    __typename?: "Sale"
    id?: string | null
    time?: string | null
    historicItems?: string | null
  }> | null
}
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "userLoggedIn" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "ItemInput" } },
          },
        },
      ],
      selectionSet: {
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "buyerId" } },
          type: {
            kind: "NonNullType",
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "itemInputs" } },
          type: {
            kind: "NonNullType",
            type: {
              kind: "ListType",
            ...
            arguments: [
              {
                ...
                value: { kind: "Variable", name: { kind: "Name", value: "buyerId" } },
              },
              {
                kind: "Argument",
                name: { kind: "Name", value: "itemInputs" },
                value: { kind: "Variable", name: { kind: "Name", value: "itemInputs" } },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
                ...
                { kind: "Field", name: { kind: "Name", value: "buyerId" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "id" } },
                      { kind: "Field", name: { kind: "Name", value: "time" } },
                      { kind: "Field", name: { kind: "Name", value: "historicItem" } },
                    ],
                  },
                },
              ],
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "picture" } },
          type: {
            kind: "NonNullType",
            ...
            arguments: [
              {
                ...
                value: { kind: "Variable", name: { kind: "Name", value: "picture" } },
              },
            ],
          },
        ],
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "itemsForSale" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<ItemsForSaleQuery, ItemsForSaleQueryVariables>
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "itemsByUser" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
...
} as unknown as DocumentNode<ItemsByUserQuery, ItemsByUserQueryVariables>
export const UserPurchaseDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "userPurchase" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "userId" } },
...
} as unknown as DocumentNode<UserPurchaseQuery, UserPurchaseQueryVariables>
export const UserSalesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "userSales" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "userId" } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                { kind: "Field", name: { kind: "Name", value: "id" } },
                { kind: "Field", name: { kind: "Name", value: "time" } },
                { kind: "Field", name: { kind: "Name", value: "historicItems" } },
              ],
            },
          },
        ],
...
} as unknown as DocumentNode<UserSalesQuery, UserSalesQueryVariables>
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "userWallet" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [{ kind: "Field", name: { kind: "Name", value: "userWallet" } }],
      },
    },
  ],
} as unknown as DocumentNode<UserWalletQuery, UserWalletQueryVariables>
export const AddCreditsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "addCredits" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "creditChange" } },
          type: {
            kind: "NonNullType",
        ...
        selections: [
          {
            ...
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "creditChange" },
                value: { kind: "Variable", name: { kind: "Name", value: "creditChange" } },
              },
            ],
          },
        ],
...
} as unknown as DocumentNode<AddCreditsMutation, AddCreditsMutationVariables>
